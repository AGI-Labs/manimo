...
class AIAgent:
    ...
    def get_action(self, obs):
        ...
        arm_action = new_action
        arm_action[-1] =  float(arm_action[-1] > 0.8)
        # arm_action[-1] = -1 if arm_action[-1] < 0 else 1
...
def main():
    ...
    parser.add_argument("--agent_paths", nargs="+", default=["/home/nitro/Downloads/kinova-arm/2023-10-29_13-09-52/run0_franka_vit_base/iter_50000_kinova_stacking_gates_latest.ckpt"])
